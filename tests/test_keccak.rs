...
fn opencl_keccak256(data: &[u8]) -> ocl::Result<[u8; 32]> {
    ...
    // 创建内核
    let kernel = proque
        .kernel_builder("keccak256_kernel")
        .arg(&input_buffer)
        .arg(data.len() as u32)
        .arg(&output_buffer)
        .build()?;
...
mod tests {
    ...
    fn test_keccak256_public_key() {
        ...
        let public_key: [u8; 65] = [
            0x04, // 前缀
            0xdc, 0x28, 0x6c, 0x82, 0x1c, 0x74, 0x90, 0xaf, 0xbe, 0x20, 0xa7, 0x9d, 0x13, 0x12,
            0x3b, 0x9f, 0x41, 0xf3, 0xd7, 0xef, 0x21, 0xe4, 0xa9, 0xca, 0xac, 0xd2, 0x2f, 0x59,
            0x83, 0xb2, 0x8e, 0xca, 0x0e, 0x4d, 0xbd, 0x56, 0x24, 0x50, 0x5a, 0x2c, 0x96, 0x8f,
            0xec, 0x15, 0xf2, 0x59, 0x90, 0xc7, 0x32, 0x47, 0x36, 0x89, 0x0f, 0x6d, 0x0f, 0x74,
