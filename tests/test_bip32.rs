...
mod tests {
    ...
    fn mod_add_n(a: &[u8; 32], b: &[u8; 32]) -> [u8; 32] {
        ...
        if carry > 0 || uint256_cmp_be(&sum, &n_u64) >= 0 {
            ...
            for i in (0..4).rev() {
                ...
                borrow = if sum[i] < n_u64[i] || (sum[i] == n_u64[i] && borrow == 1) {
                    1
                } else {
                    0
                };
    ...
    fn test_key_serialization() {
        ...
        assert_eq!(
            public_bytes.to_vec(),
            recovered_public.serialize_uncompressed().to_vec()
        );
    }
    ...
    fn test_bip32_step_by_step_comparison() {
        ...
        let master_key: [u8; 64] = [
            0x23, 0x5b, 0x34, 0xcd, 0x7c, 0x9f, 0x6d, 0x7e, 0x45, 0x95, 0xff, 0xe9, 0xae, 0x4b,
            0x1c, 0xb5, 0x60, 0x6d, 0xf8, 0xac, 0xa2, 0xb5, 0x27, 0xd2, 0x0a, 0x07, 0xc8, 0xf5,
            0x6b, 0x23, 0x42, 0xf4, 0xf4, 0x0e, 0xaa, 0xd2, 0x16, 0x41, 0xca, 0x7c, 0xb5, 0xac,
            0x00, 0xf9, 0xce, 0x21, 0xca, 0xc9, 0xba, 0x07, 0x0b, 0xb6, 0x73, 0xa2, 0x37, 0xf7,
            0xbc, 0xe5, 0x7a, 0xcd, 0xa5, 0x43, 0x86, 0xa4,
        ];
        ...
        let expected: [u8; 32] = [
            0x10, 0x53, 0xfa, 0xe1, 0xb3, 0xac, 0x64, 0xf1, 0x78, 0xbc, 0xc2, 0x10, 0x26, 0xfd,
            0x06, 0xa3, 0xf4, 0x54, 0x4e, 0xc2, 0xf3, 0x53, 0x38, 0xb0, 0x01, 0xf0, 0x2d, 0x1d,
            0x8e, 0xfa, 0x3d, 0x5f,
        ];
